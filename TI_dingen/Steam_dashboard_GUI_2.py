...
def mensen_online():
    ...
    info_2 = Label(Online_mensen_frame, text=f'steamid2: "{data_knop[0][0]}"\n\n'
                                             f'naam2\n\n'
                                             f'status2',font=('Helvetica', 12, 'bold italic'), justify=LEFT, bg='#1b2838', fg='#c7d5e0')
    info_2.grid(row=2,column=2)
    profielfoto_2 = Label(Online_mensen_frame, image=data_knop[0][3], anchor=W, bg='#1b2838', fg='#c7d5e0')
    profielfoto_2.grid(row=2,column=0, ipadx = 30)

    info_3 = Label(Online_mensen_frame, text=f'steamid3: "{data_knop[0][0]}"\n\n'
                                             f'naam3\n\n'
                                             f'status3',font=('Helvetica', 12, 'bold italic'), justify=LEFT, bg='#1b2838', fg='#c7d5e0')
    info_3.grid(row=3,column=2)
    profielfoto_3 = Label(Online_mensen_frame, image=data_knop[0][3], anchor=W, bg='#1b2838', fg='#c7d5e0')
